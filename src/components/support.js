...
letterSpacing: "0em",}
  ...
  fontSize: "12px",fontWeight:"500",color:"rgba(117, 117, 117, 1)",letterSpacing: "0em",marginTop:"15px",marginBottom:"15px",marginLeft:"30px"}
...
return(
  ...
  fontSize: "16px",fontWeight:"500",color:"rgba(0, 0, 0, 1)",letterSpacing: "0em",position:"absolute",marginLeft:"100px",marginTop:"30px",overflow:"hidden",overflowY:"scroll"}}>
 ...
 <p style={stip} id="reqem4">04</p> <p   style={styl}> How can i set up a new website?    </p>  
  { klik3 && ( <Text/>)}
</li> 
