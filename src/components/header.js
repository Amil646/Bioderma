...
letterSpacing: "0em",color: "#FFFFFF",}}>
 Bioderma, Institut Esthederm ve Etat Pur rəsmi satış saytıdır.
  </li>
  <li class="nav-item " style={{marginLeft:"270px",paddingTop:"10px",   color:"#FFFFFF",   fontFamily: "Poppins",
fontSize: "16px",fontWeight: "500",lineHeight: "20px",letterSpacing: "0em",}}>
 +994 12 123 4567
  </li>
  </ul>
